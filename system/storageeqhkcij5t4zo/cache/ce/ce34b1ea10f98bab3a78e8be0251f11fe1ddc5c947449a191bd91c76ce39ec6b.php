...
/* mintleaf/template/account/register.twig */
class __TwigTemplate_2456206d5b94a641f77f88b419cf12ce6368c27c6b603203bfe811fe4dec3b2e extends Twig_Template
{
      ...
      <form action=\"";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["custom_field"]) {
            ...
            if (($this->getAttribute($context["custom_field"], "type", array()) == "select")) {
                ...
                echo "\">
            <label class=\"col-sm-3 control-label\" for=\"input-custom-field";
                // line 78
                echo $this->getAttribute($context["custom_field"], "custom_field_id", array());
                echo "\">";
...
";
    ...
    {
        return "mintleaf/template/account/register.twig";
    }
...
/*             <div class="col-sm-9">{% for customer_group in customer_groups %}*/
...
/*           <div class="form-group required">*/
/*             <label class="col-sm-3 control-label" for="input-password">{{ entry_password }}</label>*/
/*             <div class="col-sm-9">*/
...
/*           </div>*/
/*           <div class="form-group required">*/
/*             <label class="col-sm-3 control-label" for="input-confirm">{{ entry_confirm }}</label>*/
/*             <div class="col-sm-9">*/
...
/*             {% endif %}*/
/*             &nbsp;*/
/*             <input type="submit" value="{{ button_continue }}" class="btn btn-main" />*/
/*           </div>*/
/*         </div>*/
/*         {% else %}*/
/*         <div class="buttons clearfix">*/
